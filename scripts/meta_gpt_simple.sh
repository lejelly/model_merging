...
COMP_FILE_PATH=./results_metagpt/math_code_jp/metagpt_simple/${DATASETNAME}.txt
LOG_RESP_PATH=./results_metagpt/math_code_jp/metagpt_simple/${DATASETNAME}/json_logs/Metagpt_blackbox.json
...
INITIAL_LAMBDA_FILEPATH="/work/gb20/b20042/model_merging/lambdas/math_code_jp/metagpt_simple/initial_lambdas_metagpt_alpha_MAmmoTH2-7B_Mistral-7B-codealpaca-lora_shisa-gamma-7b-v1.csv"
