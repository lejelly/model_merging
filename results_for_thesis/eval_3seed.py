...
def process_seed(seed_number):
    ...
    results = {
        ...
        'random_normalize': {'name': 'random_normalize', 'gsm8k': None, 'mbpp': None, 'ja_mgsm': None},
    ...
    dir_mapping = {
        ...
        'metagpt_random_normalize': 'random_normalize',
    ...
    for dir_name in dir_mapping.keys():
        ...
        if os.path.exists(dir_path):
            ...
            # MBPPスコアを取得
            mbpp_filename = f'seed{seed_number}_{dir_name}_adam_epochs10_lr0.001_sample4.json'
